...
func main() {
	...
	dataset, err := os.Open("../Data/Traffic_Crashes_Mini_Dataset.csv")
	// dataset, err := os.Open("../Data/Traffic_Crashes_-_Crashes.csv")
	// after running with large data set change it to Traffic_Crashes_-_Crashes.csv
